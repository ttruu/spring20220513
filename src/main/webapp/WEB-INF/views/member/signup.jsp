...
$(document).ready(function() {
	...
	$("#passwordInput1, #passwordInput2").keyup(function() {
		...
		pwOk = false;
		if(pw1 === pw2) {
			$("#passwordMessage1").text("비밀번호가 일치합니다");
			pwOk = true;
		} else {
			$("#passwordMessage1").text("비밀번호가 일치하지 않습니다");
		}
		enableSubmit();
...
<div>
	...
	<button id="checkIdButton1" type="button">아이디중복확인</button> 
	<p id="idMessage1"></p> <br />
	
	비밀번호 : <input id="passwordInput1" type="text" name="password" /> <br />
	비밀번호 확인 : <input id="passwordInput2" type="text" name="passwordConfirm" />
	<p id="passwordMessage1"></p> <br />
	
	이메일 : <input type="email" name="email" />
	<button id="checkEmailButton1" type="button">이메일중복확인</button>
	<p id="emailMessage1"></p> <br />
	
	닉네임 : <input type="text" name="nickName"  />
	<button id="checkNickNameButton1" type="button">닉네임중복확인</button>
